            ...
            <div class="row mb-3">
              ...
              <div class="row mb-3">
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="ApellidoP" value="{{ Auth::user()->ApellidoP }}" class="form-control @error('name') is-invalid @enderror" required>
                      @error('name')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
              ...
              <div class="row mb-3">
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="ApellidoM" value="{{ Auth::user()->ApellidoM }}" class="form-control @error('name') is-invalid @enderror" required>
                      @error('name')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
              ...
              <div class="row mb-3">
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="TelefonoP" value="{{ Auth::user()->TelefonoP }}" class="form-control @error('name') is-invalid @enderror" required>
                      @error('name')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
