                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="TelefonoP" type="text" class="form-control @error('TelefonoP') is-invalid @enderror" name="TelefonoP" value="{{ old('TelefonoP') }}" required autocomplete="TelefonoP" autofocus>
